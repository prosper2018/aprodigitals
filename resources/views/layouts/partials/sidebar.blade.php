<nav id="sidebar" class="sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a data-bs-target="#comments" data-bs-toggle="collapse" class="sidebar-link">
                    <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Comments</span>
                    <span class="badge badge-sidebar-primary"></span>
                </a>
            ...
            <li class="sidebar-item">
                ...
                <ul id="users" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="/user">Add New User</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="/admin/users">View All Users</a></li>
                </ul>
            </li>
